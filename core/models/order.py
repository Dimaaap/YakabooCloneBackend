...
class Order(Base):
    ...
    new_post_office_id: Mapped["NewPostOffice"] = relationship("NewPostOffice", back_populates="orders")
    ...
    ukrpost_office_number: Mapped[int] = mapped_column(ForeignKey("ukrpost_offices.office_number"), nullable=True)
