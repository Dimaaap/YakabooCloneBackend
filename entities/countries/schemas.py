...
from entities.cities.schemas import CitiesSchema
from entities.delivery_terms.schemas import DeliveryTermSchema
from entities.payment_methods.schema import PaymentMethodSchema
